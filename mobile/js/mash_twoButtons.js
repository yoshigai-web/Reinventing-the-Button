...
let buttonNum=2;
let buttonX = [80, 210], buttonY = [350, 350], buttonWidth = 70, buttonHeihgt = 100, isPressed=[false, false];
let bought = false;
let img;
...
function draw() {
    ...
    if (bought) {
        ...
        for(let i=0; i<buttonNum; i++){
            ...
            fill(216, 128);
            rect(buttonX[i], buttonY[i]+buttonHeihgt, buttonWidth, -map(cnt, 0, MAX_cnt, 0, buttonWidth), 5, 5);
        }
    }
